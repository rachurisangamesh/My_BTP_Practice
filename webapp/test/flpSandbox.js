		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Create Sales Order App",
									"targetURL": "#comtechesdproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtechesdproject1-display": {
								"semanticObject": "comtechesdproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.teche.sd.project1",
									"url": sap.ui.require.toUrl("com/teche/sd/project1")
								}
							}
						}
					}
